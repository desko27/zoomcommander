...
var ZoomPreMeeting = (function () {
  ...
  function init(opts) { 
    ...
    function onGetInviteEmailContent(MeetingUniqueID, PremeetingAPIResult, content) {
      if (_onGetInviteEmailContent) {
        _onGetInviteEmailContent(MeetingUniqueID, PremeetingAPIResult, content)
      }
    }
    ...
    return {
      ...
      */
      ...
      /**
      * mode: Set On Get Invite Email Content CB
